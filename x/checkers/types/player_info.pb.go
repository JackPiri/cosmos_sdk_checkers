...
type PlayerInfo struct {
	...
	TotalGames uint64 `protobuf:"varint,2,opt,name=totalGames,proto3" json:"totalGames,omitempty"`
}
...
func (m *PlayerInfo) GetTotalGames() uint64 {
	if m != nil {
		return m.TotalGames
	}
	return 0
...
var fileDescriptor_bf6a947f357a352f = []byte{
	...
	0x1b, 0x17, 0x57, 0x00, 0x58, 0x9d, 0x67, 0x5e, 0x5a, 0xbe, 0x90, 0x04, 0x17, 0x7b, 0x62, 0x72,
	0x72, 0x7e, 0x69, 0x5e, 0x89, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0x67, 0x10, 0x8c, 0x2b, 0x24, 0xc7,
	0xc5, 0x55, 0x92, 0x5f, 0x92, 0x98, 0xe3, 0x9e, 0x98, 0x9b, 0x5a, 0x2c, 0xc1, 0xa4, 0xc0, 0xa8,
	0xc1, 0x12, 0x84, 0x24, 0xe2, 0xe4, 0x72, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f,
	0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c,
	0x51, 0x5a, 0xe9, 0x99, 0x25, 0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x89, 0x39, 0x99,
	0xc9, 0xa9, 0x08, 0x17, 0x56, 0x20, 0x98, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x77,
	0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xe7, 0xca, 0x8c, 0x8c, 0xce, 0x00, 0x00, 0x00,
}
...
func (m *PlayerInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TotalGames != 0 {
		i = encodeVarintPlayerInfo(dAtA, i, uint64(m.TotalGames))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Account) > 0 {
		...
		i = encodeVarintPlayerInfo(dAtA, i, uint64(len(m.Account)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *PlayerInfo) Size() (n int) {
	...
	if m.TotalGames != 0 {
		n += 1 + sovPlayerInfo(uint64(m.TotalGames))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalGames |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
